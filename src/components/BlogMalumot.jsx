        ...
        <div className='xl:flex xl:justify-between gap-16'>
          ...
          <div className='flex flex-col w-full md:w-[450px]'>
            ...
            <ul className='w-full grid gap-7'>
              {bolg.map((e) => {
                return (
                  <li key={e.id} className='show rounded-lg p-4'>
...
// Define PropTypes for the BlogMalumot component
BlogMalumot.propTypes = {
  bolg: PropTypes.arrayOf(
    PropTypes.shape({
      id: PropTypes.number.isRequired,
      title: PropTypes.string.isRequired,
      title1: PropTypes.string,
      img: PropTypes.string.isRequired,
      naprumir: PropTypes.string,
      brit2: PropTypes.string,
      text2: PropTypes.string,
      pirv: PropTypes.string,
    })
  ).isRequired,
};
