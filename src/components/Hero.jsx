...
const Hero = () => {
  ...
  return (
    <div className=''>
    {/* Hero */}
      <div className='w-full p-10 h-[700px] max-w-[1300px] mx-auto mb-10 hero'>
        <Swiper
          ...
          className="mySwiper relative items-center"
        >
          ...
          <div>
            <button className='flex justify-center items-center w-10 h-10 absolute z-40 top-[291px] left-2 rounded-full bg-white show' onClick={prevSlider}>
            ...
            <button className='flex justify-center items-center w-10 h-10 absolute z-40 right-2 top-[291px] rounded-full bg-white show' onClick={nextSlider}>
              <svg data-v-46bd6466="" width="24" height="24" viewBox="0 0 24 24" fill="#000" xmlns="http://www.w3.org/2000/svg" className="ui-icon ">
